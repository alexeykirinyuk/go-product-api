...
```sh
[I] ➜ grpc_cli call localhost:8082 DescribeProductV1 "id: 1"
connecting to localhost:8082
Rpc failed with status code 5, error message: Product not found
```
...
```sh
$ pgcli "postgresql://docker:docker@localhost:5432/omp_Product_api"
```
